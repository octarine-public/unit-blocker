import { DOTAUnitMoveCapability_t, Entity, EntityManager, ExecuteOrder, Menu as MenuSDK, Unit, Vector3 } from "wrapper/Imports"
...
export default function Menu(root: MenuSDK.Node) {
	...
	const ControllablesTree = root.AddNode(root.InternalName + " - Controllables")
